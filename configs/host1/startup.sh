#!/bin/sh
# ============================================================
# host1 — VLAN 100, LACP bond to leaf1a (eth1) and leaf1b (eth2)
# Bond: bond0 (802.3ad/LACP), VLAN subinterface: bond0.100
# Static IP: 192.168.100.10/24   Gateway: 192.168.100.1
# ============================================================
...
# Create VLAN 100 tagged subinterface on the bond
ip link add link bond0 name bond0.100 type vlan id 100
ip link set bond0.100 up

# Assign static IP and default gateway
ip addr add 192.168.100.10/24 dev bond0.100
ip route add default via 192.168.100.1

echo "=== host1 network configuration complete ==="
